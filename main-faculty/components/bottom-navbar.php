    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav d-block mx-auto">
                ...
                <a href="myCalendar.php"><img src="img/mycalendar-icon.png" class="icon-navbar-btm block-navbar-btm"></a>
        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item menu-right">
                <h4 style="color:white;">Name of Prof</h4><br>
                <h6 style="color:white; margin-top: -30px; float: right;">Prof Id:</h6>
            </li>
        </ul>
    </div>
</nav>
