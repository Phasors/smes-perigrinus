...
if(isset($_POST['submit']))
{
	...
	$ccode=$_POST['chacode'];
	$cdes=$_POST['chades'];
	$ccry=$_POST['chacryrsc'];
	$ccday=$_POST['chaday'];
	$cctime=$_POST['chatime'];
	$ccroom=$_POST['charoom'];
	$ccunits=$_POST['chaunits'];
	...
	//new line
	$pdf->Cell(0,10,"Current Details",0,1);
	...
	//new line
	$pdf->Cell(0,10,"Changed Details",0,1);

	$pdf->Cell(45,10,"Code ",1,0);
	$pdf->Cell(145,10,$ccode,1,1);
	$pdf->Cell(45,10,"Description",1,0);
	$pdf->Cell(145,10,$cdes,1,1);
	$pdf->Cell(45,10,"Course,Yr&Sec",1,0);
	$pdf->Cell(145,10,$ccry,1,1);
	$pdf->Cell(45,10,"Day",1,0);
	$pdf->Cell(145,10,$ccday,1,1);
	$pdf->Cell(45,10,"Time",1,0);
	$pdf->Cell(145,10,$cctime,1,1);
	$pdf->Cell(45,10,"Room",1,0);
	$pdf->Cell(145,10,$ccroom,1,1);
	$pdf->Cell(45,10,"Units",1,0);
	$pdf->Cell(145,10,$ccunits,1,1);
	$pdf->Output();
}
