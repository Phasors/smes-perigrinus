...
<form action="./request/savepdfchange.php" method="POST">
<?php
		...
		<div class="card-body">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" style="font-size: 15px" name="college-int" class="form-control" value="<?php echo $college_name;?>" disabled><br>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<label>Student No.</label>
					<input type="text" style="font-size: 15px" name="stud-no" value="<?php echo $stdnt_no;?>"class="form-control" disabled><br>
				</div>
				<div class="col-sm-4">
					<label>Application Date</label>
					<input type="date" style="font-size: 15px" name="app-date" class="form-control" value="<?php echo date('Y-m-d'); ?>" disabled>
				</div>
			</div>
<?php } }
}
 ...
 ?>
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" style="font-size: 15px" name="stud-name" value="<?php echo $fname."&nbsp;&nbsp; ".$mname."&nbsp;&nbsp; ".$lname;?>" class="form-control" disabled><br>
				</div>
			</div>
<?php 
}
...
?>
			<div class="row">
				<div class="col-sm-3">
					...
					<input type="text" style="font-size: 15px" name="crsyrsc" value="<?php echo $prog_code.", ".$yr_lvl."-".$blocks;?>" class="form-control" disabled><br>
				</div>
 <?php
...
?>
				<div class="col-sm-3">
					...
					<input type="text" style="font-size: 15px" name="acad-yr" value="<?php echo $ay;?>"class="form-control" disabled>
				</div>
<?php 
?>
				<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<textarea class="form-control" rows="3" name="reason-box"></textarea>
				</div>
			</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-hover">
					...
					<tbody>
						<tr>
							<td><input type="text" name="chacode" class="form-control"></td>
							<td><input type="text" name="chades" class="form-control"></td>
							<td><input type="text" name="chacryrsc" class="form-control"></td>
							<td><input type="text" name="chaday" class="form-control"></td>
							<td><input type="text" name="chatime" class="form-control"></td>
							<td><input type="text" name="charoom" class="form-control"></td>
							<td><input type="text" name="chaunits" class="form-control"></td>
							<td><input type="text" name="" class="form-control" disabled></td>
							<td><input type="text" name="" class="form-control" disabled></td>
						</tr>
					</tbody>
		...
		<div class="row">
				<div class="col-sm-12">
					<br>
					<input type="button" class="btn-info" href="#" data-toggle="modal" data-target="#ssave" value="submit" style="float: right;">
				</div></div>
	</div> <!-- card -->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
							...
							<div class="row">
								<div class="col-sm-12">
									<br>
									<input type="submit" name="submit" class="btn-info" value="Save as PDF" style="float: right;">
								</div>
							</div>
					</div>
				</div>
