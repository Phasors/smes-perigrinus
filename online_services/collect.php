...
if(isset($_POST)){
	...
	if(mysqli_num_rows($existcheck)==0||!$existcheck){
		...
		$sql = "INSERT INTO student_applicants(fname,mname,lname,email,address,dob) VALUES ('".$_POST["FName"]."','".$_POST["MName"]."','".$_POST["LName"]."','".$_POST["email"]."','$add','".$_POST["Bdate"]."')";
	...
	if($_POST["form"]=="1"){
		...
		$sql2 = "INSERT INTO college_applicants(stdnt_appli_id,SHS_school,SHS_track,JHS_school,pref_course1,pref_course2,pref_course3) VALUES ('$applicant_id[0]','$SHS','$strand','$JHS','$pref1','$pref2','$pref3')";
