...
ADD CONSTRAINT `student_load_cns_3` FOREIGN KEY (`stdnt_info_id`) REFERENCES `stdnt_info` (`stdnt_info_id`);
;
...
ADD CONSTRAINT `stdnt_info_cns_2` FOREIGN KEY (`acad_back_info_id`) REFERENCES `acad_back_info` (`acad_back_info_id`),
ADD CONSTRAINT `stdnt_info_cns_3` FOREIGN KEY (`program_id`) REFERENCES `program` (`program_id`),
ADD CONSTRAINT `stdnt_info_cns_4` FOREIGN KEY (`curriculum_id`) REFERENCES `curriculum` (`curriculum_id`);
